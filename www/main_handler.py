...
class MainHandler(handler.Handler):
    """Class that manages index page. This page is only viewed when user is not logged in, else is sent to kitchen."""
    ...
    def get(self):
        ...
        if user_id:
            ...
            # If user is not logged, render main page and show new recipes published ordered by creation time.
            limit = 10
